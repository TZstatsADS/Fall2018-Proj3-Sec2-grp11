...
if(run.cv){
  ...
  plot(model_values, err_cv[,1], xlab="Interaction Depth", ylab="CV Error",
       main="Cross Validation Error", type="n", ylim=c(0, 0.10))
...
```{r superresolution}
source("../lib/imsuperresolution.R")
